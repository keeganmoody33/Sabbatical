...
| 3 | LinkedIn applied list complete, including pages beyond 10 | Unmet | Drive has no Job Applications.csv. LinkedIn data-download receipt not in 33@lecturesfrom.com. |
| 4 | Ladders applied list exported in full | Unmet | Only the three Apply4Me Gmail receipts in the prior harvest. No full list in Drive or this mailbox. |
| 5 | Jobright tracker exported in full | Unmet | 40-row CSV cited as [S4] is not in this workspace. This mailbox has Jobright signup 2025-11-18 plus alerts, not a tracker export. |
