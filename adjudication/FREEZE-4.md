...
- Overlay opportunity rows in `coding/confirmed/` (not copied into the 298): Adam Andrewjeski / Stellar Growth, Doug Shankman / AICRO informal CRO idea (not merged with AICRO applications), Mixmax Heath parent for the interview event
