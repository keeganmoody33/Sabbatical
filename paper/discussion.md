...
|---|---|---|---|---|
| 1 | 14/298 | Results, Fig 4 | measured |
| 2 | 77 with zero interview-set events | paper/RESULTS.md, log 059 C4 | measured |
| 3 | money outside the 14 | ORIGINS.md; C5 rewrite | measured, naming pass required |
| 4 | Mercor marketplace in 298 | 6 rows | measured |
| 5 | 124 still_open | Freeze 1 terminal_outcome | measured |
| 6 | cafe origins | ORIGINS.md, tagged memory where stated | memory or artifact as labeled |
| 7 | Doug at Renoir | ORIGINS.md, log 044, log 058 | measured meeting date; identity screenshot later |
| 8 | completeness | not computed | unknown |
-->
