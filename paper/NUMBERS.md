...
| Application to interview rate | 11/223 | `views/funnel_by_role_lane.csv` | sum `n_interviewed` over sum `n_applications` |
...
| interview set found by both coders | 9 of 11, `adjudication/LATENCY.md` |
...
- 221 applications and 13/221. Superseded at Freeze 3 by 223 and 14/223, then at Freeze 4 by 11/223.
